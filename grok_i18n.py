...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en-US": {
        ...
        "lm_test_ok": "LM Studio connection is available",
        "lm_test_fail": "LM Studio connection failed",
        "confirm_stop_on_close": "A task is still running. Stop the task and close the window?",
    ...
    "zh-CN": {
        ...
        "lm_test_ok": "LM Studio 连接正常",
        "lm_test_fail": "LM Studio 连接失败",
        "confirm_stop_on_close": "任务仍在运行，是否先停止任务并关闭窗口？",
    ...
    "ja-JP": {
        ...
        "lm_test_ok": "LM Studio に接続できました",
        "lm_test_fail": "LM Studio 接続に失敗しました",
        "confirm_stop_on_close": "タスク実行中です。停止してウィンドウを閉じますか？",
