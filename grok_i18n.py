...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en-US": {
        ...
        "stopping_process_tree": "Stopping subprocess tree...",
        "lm_studio_connection_title": "LM Studio Connection",
        "lm_studio_connection_ok": "LM Studio connection is available.",
        "lm_studio_connection_failed": "Cannot connect to LM Studio:",
        "lm_studio_connection_help": (
            "Cannot connect to LM Studio. Please confirm:\n"
            "1. LM Studio is open\n2. Local Server is started\n"
            "3. Base URL is usually http://127.0.0.1:1234/v1\n4. Firewall is not blocking"
        ),
        "confirm_close_title": "Confirm close",
        "confirm_close_running_task": "A task is still running. Closing will stop it. Continue?",
    ...
    "zh-CN": {
        ...
        "test_lmstudio_connection": "测试 LM Studio 连接",
        ...
        "stopping_process_tree": "正在终止子进程树……",
        "lm_studio_connection_title": "LM Studio 连接",
        "lm_studio_connection_ok": "LM Studio 连接正常。",
        "lm_studio_connection_failed": "无法连接 LM Studio：",
        "lm_studio_connection_help": (
            "无法连接 LM Studio。请确认：\n"
            "1. LM Studio 已打开\n2. Local Server 已启动\n"
            "3. Base URL 通常是 http://127.0.0.1:1234/v1\n4. 防火墙没有拦截"
        ),
        "confirm_close_title": "确认关闭",
        "confirm_close_running_task": "当前任务仍在运行，关闭窗口会停止任务。是否继续？",
    ...
    "ja-JP": {
        ...
        "test_lmstudio_connection": "LM Studio 接続テスト",
        ...
        "stopping_process_tree": "サブプロセスツリーを停止しています……",
        "lm_studio_connection_title": "LM Studio 接続",
        "lm_studio_connection_ok": "LM Studio に接続できます。",
        "lm_studio_connection_failed": "LM Studio に接続できません:",
        "lm_studio_connection_help": (
            "LM Studio に接続できません。確認してください：\n"
            "1. LM Studio を起動\n2. Local Server を開始\n"
            "3. Base URL は通常 http://127.0.0.1:1234/v1\n4. ファイアウォールで遮断されていない"
        ),
        "confirm_close_title": "終了確認",
        "confirm_close_running_task": "タスク実行中です。ウィンドウを閉じると停止します。続行しますか？",
